<template>
   <router-link :to="'/article/' + article.slug" class="article-item">
      ...
      <div class="article-item__badges">
         <article-badge :variant="'category'" :color="categoryColors[article.category]">{{
            article.category}}</article-badge>
         <article-badge :variant="'type'" :color="typeColors[article.type]">{{ article.type }}</article-badge>
         <article-badge :variant="'difficulty'"
            :color="difficultyColors[article.difficulty]">{{ article.difficulty }}</article-badge>
      </div>
   </router-link>
</template>
